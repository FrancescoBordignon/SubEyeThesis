...
with open('renders_colored_matches_pair/renders_colored_matches.txt', 'a') as file:
	file.write("id     | matches\n ")

# In[5]:
for i in range(0,146,2): 
# Load example images
	img0_pth = "EfficientLoFTR/assets/renders_colored/"+str(i)+".jpg"
	img1_pth = "EfficientLoFTR/assets/renders_colored/"+str(i+1)+".jpg"
...
# Draw
	...
	fig = make_matching_figure(img0_raw, img1_raw, mkpts0, mkpts1, color, text=text, path="renders_colored_matches_pair/rendercolored_match"+str(i)+".pdf")
