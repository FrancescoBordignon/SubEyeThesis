...
with open('real_matches_pair/real_matches.txt', 'a') as file:
	file.write("id     | matches\n ")
folder_path = 'EfficientLoFTR/assets/real_images_scaled/'
...
# Draw
	...
	fig = make_matching_figure(img0_raw, img1_raw, mkpts0, mkpts1, color, text=text, path="real_matches_pair/real_match"+str(i)+".png")
